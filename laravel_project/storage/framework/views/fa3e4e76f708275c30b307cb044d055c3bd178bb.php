...
unset($__errorArgs, $__bag); ?>" name="user_prefer_language">
                                    ...
                                    <?php $__currentLoopData = \App\Setting::LANGUAGES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting_languages_key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($setting_languages_key); ?>" <?php echo e((old('user_prefer_language') ? old('user_prefer_language') : $login_user->user_prefer_language) == $setting_languages_key ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/user/profile/edit.blade.php ENDPATH**/ ?>