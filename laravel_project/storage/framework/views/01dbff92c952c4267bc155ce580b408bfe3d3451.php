...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-3 text-right">
            <a href="<?php echo e(route('user.items.sections.index', ['item' => $item])); ?>" class="btn btn-info btn-icon-split">
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="<?php echo e(route('user.items.sections.update', ['item' => $item, 'item_section' => $item_section])); ?>">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="row align-items-center pt-2 mb-2 border-left-info <?php echo e($all_item_section_collections_key%2 == 0 ? 'bg-light' : ''); ?>">
                        ...
                        <?php if($collection->item_section_collection_collectible_type == \App\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT): ?>
                            ...
                            <div class="col-lg-7 col-md-6 col-sm-12">
                                ...
                                |
                                <span class="text-gray-800"><?php echo e($product_currency_symbol . number_format($find_product->product_price, 2)); ?></span>
                                |
                                ...
                                <?php endif; ?>
                                |
                                <a target="_blank" class="ml-1" href="<?php echo e(route('user.products.edit', ['product' => $collection->item_section_collection_collectible_id])); ?>">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <form class="float-left pr-1" action="<?php echo e(route('user.items.sections.collections.rank.up', ['item' => $item, 'item_section' => $item_section, 'item_section_collection' => $collection->id])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                ...
                                <form class="float-left pr-1" action="<?php echo e(route('user.items.sections.collections.rank.down', ['item' => $item, 'item_section' => $item_section, 'item_section_collection' => $collection->id])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <button type="submit" class="btn btn-primary btn-sm text-white">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="<?php echo e(route('user.items.sections.collections.destroy', ['item' => $item, 'item_section' => $item_section, 'item_section_collection' => $collection->id])); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e(__('backend.shared.cancel')); ?></button>
                    <form action="<?php echo e(route('user.items.sections.destroy', ['item' => $item, 'item_section' => $item_section->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <button type="submit" class="btn btn-danger"><?php echo e(__('backend.shared.delete')); ?></button>
                    </form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php if($available_products->count() > 0): ?>
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('user.items.sections.collections.store', ['item' => $item, 'item_section' => $item_section])); ?>" method="POST" id="add-product-form">
                            <?php echo csrf_field(); ?>
                            ...
                            <?php $__currentLoopData = $available_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $available_products_key => $available_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row align-items-center pt-2 mb-2 border-left-info <?php echo e($available_products_key%2 == 0 ? 'bg-light' : ''); ?>">
                                    ...
                                    <div class="col-8">
                                        ...
                                        |
                                        <span class="text-gray-800"><?php echo e($product_currency_symbol . number_format($available_product->product_price, 2)); ?></span>
                                        |
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php else: ?>
                    <div class="modal-body">
                        <?php echo e(__('item_section.no-products-user')); ?>
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/user/item/item-section/edit.blade.php ENDPATH**/ ?>