        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                    <form method="POST" action="<?php echo e(route('admin.cities.update', $city)); ?>" class="">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="city_slug" value="<?php echo e(old('city_slug') ? old('city_slug') : $city->city_slug); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo e(__('country_delete.delete-city-warning')); ?></p>
                    <p><?php echo e(__('backend.shared.delete-message', ['record_type' => __('backend.shared.city'), 'record_name' => $city->city_name])); ?></p>
                </div>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/city/edit.blade.php ENDPATH**/ ?>