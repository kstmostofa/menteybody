                                ...
                                <tr>
                                    <td>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <?php else: ?>
                                                <img id="image_preview" src="<?php echo e(Storage::disk('public')->url('user/'. $user->user_image)); ?>" class="img-responsive rounded">
                                            <?php endif; ?>
                                        </div>
                                    </td>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/user/index.blade.php ENDPATH**/ ?>