...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-3 text-right">
            <a href="<?php echo e(route('admin.attributes.index')); ?>" class="btn btn-info btn-icon-split">
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <?php if($attribute_owner->isUser()): ?>
                        <div class="alert alert-warning" role="alert">
                            <?php echo e(__('product_attributes.edit-owner-alert', ['user_name' => $attribute_owner->name, 'user_email' => $attribute_owner->email])); ?>

                            <a href="<?php echo e(route('admin.users.edit', ['user' => $attribute_owner->id])); ?>" class="alert-link" target="_blank">
                                <i class="fas fa-external-link-alt"></i>
                                <?php echo e(__('product_attributes.edit-owner-alert-view-profile')); ?>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-10 col-sm-12">
                    <form method="POST" action="<?php echo e(route('admin.attributes.update', ['attribute' => $attribute->id])); ?>" class="">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo e(__('backend.shared.delete-message', ['record_type' => __('product_attribute.product-attribute'), 'record_name' => $attribute->attribute_name])); ?>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e(__('backend.shared.cancel')); ?></button>
                    <form action="<?php echo e(route('admin.attributes.destroy', ['attribute' => $attribute->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/attribute/edit.blade.php ENDPATH**/ ?>