            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        ...
                        <ul>
                            <li><?php echo e(__('sitemap_import.csv-file-upload-listing-instruction-columns')); ?></li>
                            <li><?php echo e(__('sitemap_import.csv-file-upload-listing-instruction-image-urls')); ?></li>
                            <li><?php echo e(__('sitemap_import.csv-file-upload-listing-instruction-gallery-images-urls')); ?></li>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/importer/csv/upload.blade.php ENDPATH**/ ?>