...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800"><?php echo e(__('backend.country.add-country')); ?></h1>
            <p class="mb-4"><?php echo e(__('backend.country.add-country-desc')); ?></p>
        </div>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                    <form method="POST" action="<?php echo e(route('admin.countries.store')); ?>" class="">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="country_name" value="<?php echo e(old('country_name')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="country_abbr" value="<?php echo e(old('country_abbr')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="country_slug" value="<?php echo e(old('country_slug')); ?>">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <select class="custom-select" name="country_status">
                                    <option value="<?php echo e(\App\Country::COUNTRY_STATUS_ENABLE); ?>" <?php echo e(old('country_status') == \App\Country::COUNTRY_STATUS_ENABLE ? 'selected' : ''); ?>>
                                        <?php echo e(__('setting_language.country.country-status-enable')); ?>

                                    </option>
                                    <option value="<?php echo e(\App\Country::COUNTRY_STATUS_DISABLE); ?>" <?php echo e(old('country_status') == \App\Country::COUNTRY_STATUS_DISABLE ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/country/create.blade.php ENDPATH**/ ?>