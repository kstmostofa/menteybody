...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800"><?php echo e(__('item_claim.item-claim-create-user')); ?></h1>
            <p class="mb-4"><?php echo e(__('item_claim.item-claim-create-user-desc')); ?></p>
        </div>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="<?php echo e(route('user.item-claims.store')); ?>" class="" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/user/item/item-claim/create.blade.php ENDPATH**/ ?>