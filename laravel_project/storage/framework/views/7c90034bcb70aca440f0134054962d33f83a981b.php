        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-6">
                    <form method="POST" action="<?php echo e(route('admin.custom-fields.store')); ?>" class="">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <select multiple class="custom-select" name="category[]" id="category" size="<?php echo e(count($all_categories)); ?>">
                                    <?php $__currentLoopData = $all_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e(in_array($category['category_id'], old('category') ? old('category') : array()) ? 'selected' : ''); ?> value="<?php echo e($category['category_id']); ?>"><?php echo e($category['category_name']); ?></option>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/custom-field/create.blade.php ENDPATH**/ ?>