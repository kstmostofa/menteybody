...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-8">
                    <form method="POST" action="<?php echo e(route('admin.items.reviews.update', ['item_slug' => $item->item_slug, 'review' => $review->id])); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="<?php echo e(route('admin.items.reviews.destroy', ['item_slug' => $item->item_slug, 'review' => $review->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/item/review/edit.blade.php ENDPATH**/ ?>