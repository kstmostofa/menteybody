...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-3 text-right">
            <a href="<?php echo e(route('admin.item-leads.index')); ?>" class="btn btn-info btn-icon-split">
        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <form method="POST" action="<?php echo e(route('admin.item-leads.update', ['item_lead' => $item_lead])); ?>" class="">
                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="<?php echo e(route('admin.item-leads.destroy', ['item_lead' => $item_lead])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/item/item-lead/edit.blade.php ENDPATH**/ ?>