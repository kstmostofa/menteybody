        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                    <form method="POST" action="<?php echo e(route('admin.users.profile.update')); ?>" class="">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name') ? old('name') : $user_admin->name); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email') ? old('email') : $user_admin->email); ?>">
...
unset($__errorArgs, $__bag); ?>" name="user_about"><?php echo e(old('user_about') ? old('user_about') : $user_admin->user_about); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="user_prefer_language">
                                    ...
                                    <?php $__currentLoopData = \App\Setting::LANGUAGES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting_languages_key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($setting_languages_key); ?>" <?php echo e($user_admin->user_prefer_language == $setting_languages_key ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="user_prefer_country_id">
                                    ...
                                    <?php $__currentLoopData = $all_countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all_countries_key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option <?php echo e((old('user_prefer_country_id') ? old('user_prefer_country_id') : $user_admin->user_prefer_country_id) == $country->id ? 'selected' : ''); ?> value="<?php echo e($country->id); ?>"><?php echo e($country->country_name); ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                                <div class="row mt-3">
                                    <div class="col-8">
                                        ...
                                        <?php if(empty($user_admin->user_image)): ?>
                                            <img id="image_preview" src="<?php echo e(asset('backend/images/placeholder/profile-' . intval($user_admin->id % 10) . '.webp')); ?>" class="img-responsive">
                                        <?php else: ?>
                        ...
                        <div class="row form-group justify-content-between">
                            ...
                            <div class="col-4 text-right">
                                <a class="text-danger" href="<?php echo e(route('admin.users.profile.password.edit')); ?>">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#delete_user_profile_image_button').on('click', function(){
                ...
                var ajax_url = '/ajax/user/image/delete/' + '<?php echo e($user_admin->id); ?>';
                ...
                jQuery.ajax({
                    ...
                    success: function(result){
                        ...
                        $('#image_preview').attr("src", "<?php echo e(asset('backend/images/placeholder/profile-' . intval($user_admin->id % 10) . '.webp')); ?>");
                        $('#feature_image').val("");
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/user/profile/edit.blade.php ENDPATH**/ ?>