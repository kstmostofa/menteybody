...
<?php $__env->startSection('content'); ?>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <!-- Start Filter -->
            <form method="GET" action="<?php echo e(route('page.category', ['category_slug' => $category->category_slug])); ?>" id="filter_form">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-outline-primary rounded" href="<?php echo e(route('page.category', ['category_slug' => $category->category_slug])); ?>">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/frontend/category.blade.php ENDPATH**/ ?>