        ...
        <div class="col-12">
            <div class="row">
                <div class="col-xl-6 col-lg-10 col-sm-12">
                    <form method="POST" action="<?php echo e(route('admin.attributes.store')); ?>" class="">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <label for="user_id" class="text-black"><?php echo e(__('product_attributes.form-attribute-owner')); ?></label>
                                ...
                                <small id="user_idHelpBlock" class="form-text text-muted">
                                    <?php echo e(__('product_attributes.form-attribute-owner-help')); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/attribute/create.blade.php ENDPATH**/ ?>