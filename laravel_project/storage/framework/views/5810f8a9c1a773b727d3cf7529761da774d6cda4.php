        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo e(__('delete_custom_field.delete-custom-field-warning') . ' ' . __('backend.shared.delete-message', ['record_type' => __('backend.shared.custom-field'), 'record_name' => $customField->custom_field_name])); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/custom-field/edit.blade.php ENDPATH**/ ?>