...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800"><?php echo e(__('backend.category.edit-category')); ?></h1>
            <p class="mb-4"><?php echo e(__('backend.category.edit-category-desc')); ?></p>
        </div>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-6">
                    <form method="POST" action="<?php echo e(route('admin.categories.update', $category)); ?>" class="">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="category_name" value="<?php echo e(old('category_name') ? old('category_name') : $category->category_name); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="category_slug" value="<?php echo e(old('category_slug') ? old('category_slug') : $category->category_slug); ?>">
...
unset($__errorArgs, $__bag); ?>" name="category_icon" value="<?php echo e(old('category_icon') ? old('category_icon') : $category->category_icon); ?>">
                                <small class="text-muted">
...
unset($__errorArgs, $__bag); ?>" name="category_description"><?php echo e(old('category_description') ? old('category_description') : $category->category_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="category_parent_id">
                                    <option value="0" <?php echo e(empty(old('category_parent_id') ? old('category_parent_id') : $category->category_parent_id) ? 'selected' : ''); ?>><?php echo e(__('categories.no-parent-cat')); ?></option>
                                    <?php $__currentLoopData = $printable_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $printable_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($printable_category["category_id"]); ?>" <?php echo e((old('category_parent_id') ? old('category_parent_id') : $category->category_parent_id) == $printable_category["category_id"] ? 'selected' : ''); ?>><?php echo e($printable_category["category_name"]); ?></option>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo e(__('backend.shared.delete-message', ['record_type' => __('backend.shared.category'), 'record_name' => $category->category_name])); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/category/edit.blade.php ENDPATH**/ ?>