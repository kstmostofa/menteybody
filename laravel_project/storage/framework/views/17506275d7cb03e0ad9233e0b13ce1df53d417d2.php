...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            ...
                            <p class="mb-0" style="color: <?php echo e($site_innerpage_header_paragraph_font_color); ?>;"><?php echo e($state->state_name); ?></p>
                        </div>
                    </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <!-- Start Filter -->
            <form method="GET" action="<?php echo e(route('page.category.state', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug])); ?>" id="filter_form">
...
unset($__errorArgs, $__bag); ?>" name="filter_city" id="filter_city" data-live-search="true">
                                    ...
                                    <?php $__currentLoopData = $filter_all_cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all_cities_key => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-12 text-right">
                                <a class="btn btn-sm btn-outline-primary rounded" href="<?php echo e(route('page.category.state', ['category_slug' => $category->category_slug, 'state_slug' => $state->state_slug])); ?>">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12 text-left border-primary">
                            <h2 class="font-weight-light text-primary"><?php echo e(__('frontend.category.state.sub-title-1', ['category_name' => $category->category_name, 'state_name' =>  $state->state_name])); ?></h2>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-7 text-left border-primary">
                    <h2 class="font-weight-light text-primary"><?php echo e(__('frontend.category.state.sub-title-2', ['category_name' => $category->category_name, 'state_name' => $state->state_name])); ?></h2>
                </div>
            </div>
            <div class="row mt-5">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/frontend/category/state.blade.php ENDPATH**/ ?>