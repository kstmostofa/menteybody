        ...
        <div class="col-12">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" class="">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="custom-select" name="product_status">
                                    <option value="<?php echo e(\App\Product::STATUS_PENDING); ?>" <?php echo e(old('product_status') == \App\Product::STATUS_PENDING ? 'selected' : ''); ?>><?php echo e(__('products.product-status-pending')); ?></option>
                                    <option value="<?php echo e(\App\Product::STATUS_APPROVED); ?>" <?php echo e(old('product_status') == \App\Product::STATUS_APPROVED ? 'selected' : ''); ?>><?php echo e(__('products.product-status-approved')); ?></option>
                                    <option value="<?php echo e(\App\Product::STATUS_SUSPEND); ?>" <?php echo e(old('product_status') == \App\Product::STATUS_SUSPEND ? 'selected' : ''); ?>><?php echo e(__('products.product-status-suspend')); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <label for="user_id" class="text-black"><?php echo e(__('products.form-product-owner')); ?></label>
                                ...
                                <small class="form-text text-muted">
                                    <?php echo e(__('products.form-product-owner-help')); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/product/create.blade.php ENDPATH**/ ?>