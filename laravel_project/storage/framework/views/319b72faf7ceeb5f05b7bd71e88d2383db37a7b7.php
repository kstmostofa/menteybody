                    ...
                    <?php if(!empty($item_claim->item_claim_additional_upload)): ?>
                        <div class="row mb-2">
                            <div class="col-md-12">
                                ...
                                <form id="item_claim_additional_upload_download_form" action="<?php echo e(route('user.item-claims.download.do', ['item_claim' => $item_claim])); ?>" method="POST" target="_blank">
                                    <?php echo csrf_field(); ?>
                                </form>
                            </div>
                        </div>
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/user/item/item-claim/edit.blade.php ENDPATH**/ ?>