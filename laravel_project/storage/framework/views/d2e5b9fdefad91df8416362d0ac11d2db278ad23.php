...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800"><?php echo e(__('backend.testimonial.add-testimonial')); ?></h1>
            <p class="mb-4"><?php echo e(__('backend.testimonial.add-testimonial-desc')); ?></p>
        </div>
        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-6">
                    <form method="POST" action="<?php echo e(route('admin.testimonials.store')); ?>" class="">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="testimonial_name" value="<?php echo e(old('testimonial_name')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="testimonial_company" value="<?php echo e(old('testimonial_company')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="testimonial_job_title" value="<?php echo e(old('testimonial_job_title')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="testimonial_description"><?php echo e(old('testimonial_description')); ?></textarea>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/admin/testimonial/create.blade.php ENDPATH**/ ?>