...
<head>
    ...
    <?php echo $__env->make('backend.user.partials.tracking', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div id="wrapper">
    ...
    <?php echo $__env->make('backend.user.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('backend/vendor/pace/pace.min.js')); ?>"></script>
...
<?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/user/layouts/app.blade.php ENDPATH**/ ?>