...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            ...
            <p class="mb-4"><?php echo e(__('backend.message.show-message-desc-user')); ?></p>
        </div>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row mb-4">
                    <div class="col-12">
                        <form method="POST" action="<?php echo e(route('user.messages.update', $thread->id)); ?>" class="">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/user/message/show.blade.php ENDPATH**/ ?>