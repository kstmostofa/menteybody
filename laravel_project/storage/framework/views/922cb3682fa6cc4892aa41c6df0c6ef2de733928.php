...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-8">
                    <form method="POST" action="<?php echo e(route('user.items.reviews.store', ['item_slug' => $item->item_slug])); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/uaenurse/public_html/menteybody/laravel_project/resources/views/backend/user/item/review/create.blade.php ENDPATH**/ ?>