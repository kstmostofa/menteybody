        ...
        <div class="col-12">
            <form method="post" action="{{ route('LaravelUpdater::database') }}" class="tabs-wrap">
                ...
                <div class="form-group {{ $errors->has('app_purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_purchase_code" id="app_purchase_code" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_purchase_code_placeholder') }}" />
